...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='', help='models/yolov5x.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/fall.yaml', help='data.yaml path')
